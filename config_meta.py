...
def get_train_args():
    ...
    parser.add_argument('--num_tasks', type=int, default=20000, help='Number of tasks')
...
def get_model_args():
    ...
    parser.add_argument('--p_ems2_emb', action='store_false', help='Enable p_ems2 embedding')
    parser.add_argument('--d_molformer_emb', action='store_false', help='Enable d_molformer embedding')
